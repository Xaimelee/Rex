...
NDefines.NDiplomacy.IMPERIAL_AUTHORITY_FROM_PRINCES = 0.20
NDefines.NDiplomacy.IMPERIAL_CITY_IA = 0.015
...
NDefines.NCountry.YEARS_OF_NATIONALISM = 25
...
NDefines.NCountry.RAZE_UNREST_DURATION = 5
NDefines.NCountry.RAZE_PROVINCE_DEVELOPMENT_DECREASE = 0
NDefines.NCountry.RAZE_PROVINCE_POWER_PER_DEVELOPMENT = 0
NDefines.NCountry.RAZE_TECH_BASE_LEVEL = 0
NDefines.NCountry.RAZE_TECH_POWER_DECREASE = 0
NDefines.NCountry.RAZE_TECH_POWER_DECREASE_MAX = 0
...
NDefines.NEconomy.LAND_MAINTENANCE_FACTOR = 0.20
...
NDefines.NMilitary.ARMY_DRILL_YEARLY_GAIN = 35.0
...
NDefines.NMilitary.JANISSARIES_HEATHEN_DEVELOPMENT_DIVISOR = 15
...
NDefines.NMilitary.MERCENARY_BASE_COST = 20.0

NDefines.NMilitary.FRONT_LINE_MODIFIER = 1.25
NDefines.NMilitary.BACK_LINE_MODIFIER = 0.6

NDefines.NMilitary.WAR_LENGTH_DAMAGE_MODIFIER = 0.04
...
NDefines.NMilitary.DEFAULT_WARGOAL_TICKINGWARSCORE_BONUS = 1.7
...
NDefines.NMilitary.CONDOTTIERI_PRESTIGE_BONUS = 1
NDefines.NMilitary.SUPPLYLIMIT_BASE_MULTIPLIER = 10.0

NDefines.NMilitary.MONTHLY_REINFORCE = 0.08
